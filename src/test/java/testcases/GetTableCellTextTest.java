...
/*
 * Test by getting the text value of the cell
 * Test all 6 possible scenarios
 */
...
public class GetTableCellTextTest extends TestBaseClass {
	...
	public void InsertCompanyGetContactApp() throws Exception {
		...
		for (int i = 0; i < totalRows; i++) {
			...
			String answer = tablePage.getTableCellText(tablePage.getTable(), 1, data[0], 2);
	...
	public void InsertContactGetCompanyApp() throws Exception {
		...
		for (int i = 0; i < totalRows; i++) {
			...
			String answer = tablePage.getTableCellText(tablePage.getTable(), 2, data[0], 1);
	...
	public void InsertCountryGetContactApp() throws Exception {
		...
		for (int i = 0; i < totalRows; i++) {
			...
			String answer = tablePage.getTableCellText(tablePage.getTable(), 3, data[0], 2);
